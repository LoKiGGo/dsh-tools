...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function SettingsPage(props) {
			...
			const renderTabBody = () => {
				if (activeTab === "manage") {
					// Always-on card first, then the 任务完成提示 card (授权+开关合一，
					// 常驻显示), then the toggle list.
					return [
			...
			return el("div", { className: "dt-page" },
				...
				el("p", { className: "dt-hint" }, "「功能开关」页签顶部为一键重启与任务完成提示（先授权，授权后可在卡片内开关），下方为可选功能的开关。页签超出宽度时按住左右拖动查看。"),
				el("div", {
