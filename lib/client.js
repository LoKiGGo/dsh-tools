...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		exports.__dshToolsTest = { evaluateTurnDone, nativeNoticePayload, tabModel, updateCheckDecision, deleteChatLoadDecision, catalogFilter, catalogCounts, catalogModuleShortName, catalogTabRegistration, catalogFetchGate };
