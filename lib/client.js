...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
			...
			const renderGroup = (group) => {
				...
				return el("div", { className: "dsh-delchat-group", key: group.key },
					el("div", { className: "dsh-delchat-group-head" },
						...
						group.path !== null ? el("span", { className: "dsh-delchat-muted dsh-delchat-group-path", title: group.path }, group.path) : null,
		...
		function apply(pluginCtx) {
			...
			ctx.slots.inject("settings.plugins.tab", () => {
				...
				const reconcile = () => {
					...
					if (catalogTabRegistration(configStore, "plugin-catalog")) {
		...
		exports.__dshToolsTest = { evaluateTurnDone, nativeNoticePayload, tabModel, updateCheckDecision, deleteChatLoadDecision, groupSessionsByWorkspace, catalogFilter, catalogCounts, catalogModuleShortName, catalogTabRegistration, catalogFetchGate };
