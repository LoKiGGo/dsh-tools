...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const updateCheckStore = { autoChecked: false, inFlight: false, data: null };
		...
		exports.__dshToolsTest = { evaluateTurnDone, nativeNoticePayload, tabModel, updateCheckDecision };
